...
const defaultKnobs = () => ({
  ...
  itemCol: select('itemCol', ['', ...gridItemPropCol], ''),
  itemColStart: select('itemColStart', ['', ...gridItemPropCol], ''),
  itemRow: select('itemRow', ['', ...gridItemPropRow], ''),
  itemRowStart: select('itemRowStart', ['', ...gridItemPropRow], ''),
