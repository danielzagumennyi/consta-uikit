...
type Row = '1' | '2' | '3' | '4' | 1 | 2 | 3 | 4;

type Order = '-1' | '0' | '1' | -1 | 0 | 1;
...
| Свойство     | Тип                         | По умолчанию | Описание                                                         |
| ------------ | --------------------------- | ------------ | ---------------------------------------------------------------- |
| `col?`       | `Col`                       | —            | Количество колонок которое занимает элемент                      |
| `colStart?`  | `Col`                       | —            | Сдвиг элемента в стобец                                          |
| `row?`       | `Row`                       | —            | Количество рядов которое занимает элемент                        |
| `rowStart?`  | `Row`                       | —            | Сдвиг элемента в ряд                                             |
| `order?`     | `Order`                     | —            | Сортировка, можно сбвинуть в начало или в конец                  |
| `className?` | `string`                    | —            | Дополнительный CSS-класс                                         |
| `as`         | `React.ElementType`         | 'div'        | HTML-тег, в виде которого этот компонент будет представлен в DOM |
| `ref`        | `React.Ref<HTMLDivElement>` | -            | Ссылка на DOM-элемент компонента                                 |
